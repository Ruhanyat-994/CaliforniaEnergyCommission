...
public class CF2RMCH01BE_Assertions {
    ...
    public static void runAssertions(Page page1) throws InterruptedException {
        Locator unitName = page1.locator("#dwellingUnitName");
        ...
        Locator systemName = page1.getByPlaceholder("System ID or Name...").nth(0);
        errorHandling(() -> {
        ...
        Locator systemArea = page1.getByPlaceholder("System ID or Name...").nth(1);
        errorHandling(() -> {
       ...
       // Locator squareFeet = page1.getByRole(AriaRole.TEXTBOX, new Page.GetByRoleOptions().setName(""));
        ...
        Locator numUnits = page1.getByPlaceholder("# of units...").first();
